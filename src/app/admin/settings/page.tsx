        ...
        <AccordionItem value="notifications" className="border rounded-lg shadow-lg bg-card">
          ...
          <AccordionContent className="px-6 pb-6 pt-0">
            <div className="space-y-6">
              ...
              <Button onClick={() => handleSaveChanges("Notification")} className="transition-transform hover:scale-105"><Save className="mr-2 h-4 w-4" />Save Notification Settings</Button>
            </div>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="payment" className="border rounded-lg shadow-lg bg-card">
          ...
          <AccordionContent className="px-6 pb-6 pt-0">
            <div className="space-y-6">
              ...
              <Button onClick={() => handleSaveChanges("Payment Gateway")} className="transition-transform hover:scale-105"><Save className="mr-2 h-4 w-4" />Save Payment Settings</Button>
            </div>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="advanced" className="border rounded-lg shadow-lg bg-card">
          ...
          <AccordionContent className="px-6 pb-6 pt-0">
            <div className="space-y-6">
              ...
              <Button variant="destructive" onClick={() => toast({title: "Cache Cleared (Mock)", description: "System cache has been cleared."})} className="transition-transform hover:scale-105">Clear System Cache</Button>
              <Button onClick={() => handleSaveChanges("Advanced")} className="transition-transform hover:scale-105"><Save className="mr-2 h-4 w-4" />Save Advanced Settings</Button>
            </div>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="dataManagement" className="border rounded-lg shadow-lg bg-card">
          ...
          <AccordionContent className="px-6 pb-6 pt-0">
            <div className="space-y-4">
              <Button variant="outline" className="w-full justify-start transition-transform hover:scale-105" onClick={() => toast({title:"Data Exported (Mock)", description:"User data export initiated."})}><Users className="mr-2 h-4 w-4"/>Export User Data (JSON/CSV)</Button>
              <Button variant="outline" className="w-full justify-start transition-transform hover:scale-105" onClick={() => toast({title:"Backup Created (Mock)", description:"System backup successfully created."})}> <DatabaseZap className="mr-2 h-4 w-4"/>Create Full System Backup</Button>
              <div>
              ...
              <Button onClick={() => handleSaveChanges("Data Management")} className="transition-transform hover:scale-105"><Save className="mr-2 h-4 w-4" />Save Data Policies</Button>
            </div>
          </AccordionContent>
        </AccordionItem>
